...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.sync_flag'
        db.add_column('oauth_user', 'sync_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'User.updated_at'
        db.add_column('oauth_user', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 5, 7, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.sync_flag'
        db.delete_column('oauth_user', 'sync_flag')

        # Deleting field 'User.updated_at'
        db.delete_column('oauth_user', 'updated_at')
