...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.angle_ids_str'
        db.add_column('setting_page', 'angle_ids_str',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.sort_ids_str'
        db.add_column('setting_page', 'sort_ids_str',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.angle_ids_str'
        db.delete_column('setting_page', 'angle_ids_str')

        # Deleting field 'Page.sort_ids_str'
        db.delete_column('setting_page', 'sort_ids_str')
